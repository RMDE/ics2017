...
opcode_entry opcode_table [512] = {
  ...
  /* 0xf4 */	IDEXW(E,gp4,1), IDEXW(E,gp4,1), IDEXW(E, gp3, 1), IDEX(E, gp3),
  ...
  /* 0x80 */	IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc),
  /* 0x84 */	IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc),
  /* 0x88 */	IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc),
  /* 0x8c */	IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc), IDEX(E,jcc),
  /* 0x90 */	EMPTY,  IDEXW(E,setcc,1),  IDEXW(E,setcc,1),  IDEXW(E,setcc,1),
