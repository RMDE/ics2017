...
opcode_entry opcode_table [512] = {
  ...
  /* 0x24 */	/*IDEXW(I2a, and, 1),*/EMPTY, IDEX(I2a, and), EMPTY, EMPTY,
  ...
  /* 0xe4 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(in_I2a, in, 1), IDEX(in_I2a, in), IDEXW(out_a2I, out, 1), IDEX(out_a2I, out),
